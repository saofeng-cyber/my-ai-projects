...
ALI_TONGYI_MAX_MODEL = "qwen3-max-2026-01-23"
ALI_TONGYI_TURBO_MODEL = "qwen3-max-2026-01-23"
ALI_TONGYI_DEEPSEEK_R1 = "deepseek-r1"
ALI_TONGYI_DEEPSEEK_R10528 = "deepseek-r1-0528"
ALI_TONGYI_DEEPSEEK_V3 = "deepseek-v3.1"
ALI_TONGYI_REASONER_MODEL = "qwen3-max-2026-01-23"
...
#  ollama
OLLAMA_API_KEY_OS_VAR_NAME = "OLLAMA_API_KEY"
OLLAMA_URL = "http://127.0.0.1:11434"
OLLAMA_MODEL = "qwen3.5:397b-cloud"
OLLAMA_API_KEY = "6abd79818c2b442c894323e947342bed.f30AaxqFYT00Kt8SPbxvQMlH"
...
#  本地大模型
def get_ollama_completion(model: str = OLLAMA_MODEL, temperature: float = 0.7):
    function_name = inspect.currentframe().f_code.co_name
    print(f"{function_name}-模型：{model},温度：{temperature}")
    return ChatOllama(model=model, base_url=OLLAMA_URL, temperature=temperature, validate_model_on_init=True,
                      reasoning=False)
